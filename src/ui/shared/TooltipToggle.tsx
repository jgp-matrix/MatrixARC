  ...
  return(
    <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"8px 0"}}>
      ...
      <button onClick={()=>{const next=!on;setOn(next);setTooltipsEnabled(next);}}
        style={{flexShrink:0,width:44,height:24,borderRadius:12,border:"none",cursor:"pointer",background:on?"#4f46e5":"#3a3a5a",position:"relative",transition:"background 0.2s"}}>

...
function PurchasePriceCheckModal({diffs,onAccept,onClose}){
  ...
  return ReactDOM.createPortal(
    React.createElement('div',{style:{position:'fixed',inset:0,background:'rgba(0,0,0,0.75)',zIndex:9999,display:'flex',alignItems:'center',justifyContent:'center',padding:16}},
      React.createElement('div',{style:{background:'#0d0d1a',border:'1px solid #3d6090',borderRadius:10,padding:'24px 28px',width:'100%',maxWidth:780,maxHeight:'80vh',display:'flex',flexDirection:'column',boxShadow:'0 8px 40px rgba(0,0,0,0.7)'}},
        ...
        React.createElement('div',{style:{paddingTop:12,display:'flex',gap:8,justifyContent:'flex-end',alignItems:'center'}},
          ...
          React.createElement('button',{onClick:onClose,style:{background:'#1a1a2a',border:'1px solid #3d6090',color:'#94a3b8',padding:'6px 16px',borderRadius:6,cursor:'pointer',fontSize:12,fontFamily:'inherit'}},'Dismiss')
        )
      )
    )
  ,document.body);

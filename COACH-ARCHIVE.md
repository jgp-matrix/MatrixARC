# ARC Coaching Log — Archive

> Archived findings from COACH.md. Each finding retains its original `## C<n>` or `### C<n>` heading for cross-reference anchoring.
> Live findings remain in [COACH.md](COACH.md). For the full session index, see COACH.md.
>
> **Archive date:** 2026-06-29
> **Archived findings:** C1–C99
> **Cut criteria:** (a) status resolved/complete/closed, (b) not cited by a still-live finding, (c) no resume trigger, (d) architectural lessons promoted to CLAUDE.md where applicable.

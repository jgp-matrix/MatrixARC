...
### 🐛 Bugs (B###)
- **B010 — "Manual 'Upload Supplier Quote' throws on drop (undefined field → Firestore reject)"** [Building — Jon-approved 2026-07-07, Marc fixing → v1.23.1 — MED-HIGH: aborts manual upload]

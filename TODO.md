...
### 🔧 General (G###)
- **G002 — "Automate the 4-session team startup boot"** [Discovery — awaiting Jon's approach call] — boot the CCD team (launch + onboard + comms-check) with minimal human interaction. *(source: Jon 2026-07-02, via Freddy.)*

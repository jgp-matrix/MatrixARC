...
### 🔧 General (G###)
- **G002 — "Automate the 4-session team startup boot"** [Decided — Option A: Windows launcher script; Marc to build] — boot the CCD team (launch + onboard + comms-check) with minimal human interaction. Jon chose **Option A** (2026-07-02): ~95% automation via a launcher; accept the ~6 one-time Allow-Once clicks at the comms-check. *(source: Jon 2026-07-02, via Freddy.)*
